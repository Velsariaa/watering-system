        ...
        if ($imageError === 0) {
            if ($imageSize < 5000000) {
                if (move_uploaded_file($imageTmpName, $targetFile)) {
                    ...
                    $sql = "INSERT INTO plant_data (plant_name, image_filename, width, height, datetime_captured)
                            VALUES ('$plantName', '$uniqueImageName', $plantWidth, $plantHeight, '$currentDateTime')";
